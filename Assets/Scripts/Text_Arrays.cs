...
// using this video as reference: https://www.youtube.com/watch?v=MkjVU5F1it0
    ...
    // setting up arrays
    public string[] story = {"In the 1930s, Iowa State University commissioned Grant Wood to create a set of murals on several walls of the old section of the Parks Library. The murals included agrarian, industrial and scientific themes representing different areas of knowledge.",
